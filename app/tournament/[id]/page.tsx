      ...
      <main className="max-w-2xl mx-auto px-4 py-6" dir="rtl">
          ...
          <div className="relative">
            {!profile && (
              <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-white/60 backdrop-blur-sm rounded-xl">
                ...
                <a href="/login" className="bg-blue-600 hover:bg-blue-500 text-white font-bold px-6 py-2.5 rounded-xl text-sm transition-colors">
                  כניסה / הרשמה
                </a>
              </div>
            )}
        ...
        {tab === 'standings' && (
          <div className="relative">
            {!profile && (
              <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-white/60 backdrop-blur-sm rounded-xl">
                <p className="text-slate-700 font-semibold mb-3">יש להתחבר כדי לצפות בטבלת הדירוג</p>
                <a href="/login" className="bg-blue-600 hover:bg-blue-500 text-white font-bold px-6 py-2.5 rounded-xl text-sm transition-colors">
                  כניסה / הרשמה
                </a>
              </div>
