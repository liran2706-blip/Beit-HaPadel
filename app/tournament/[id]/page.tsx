        ...
        <div className="bg-[#0a1628] text-white rounded-2xl p-5 mb-6 overflow-hidden relative">
          ...
          <div className="flex items-start justify-between mb-3">
            ...
            <span className={`text-xs font-semibold px-2.5 py-1 rounded-full shrink-0 ${
              ...
              isPast ? 'bg-slate-500/20 text-slate-300' :
          ...
          {!isPast && tournament.status !== 'active' && (
            <>
              <p className="text-blue-300 text-xs text-center mb-1">מתחיל בעוד</p>
              <Countdown date={tournament.date} time={tournament.time_start} />
            </>
          )}
          ...
          <div className="mb-4">
            <div className="flex justify-between text-xs text-blue-300 mb-1.5">
              ...
              <span>
                {isFull ? (
                  <span className="text-red-400 font-semibold">הטורניר מלא</span>
                ) : isLow ? (
                  <span className="text-orange-400 font-semibold">נותרו {available} מקומות בלבד!</span>
                ) : (
            ...
            <div className="bg-white/10 rounded-full h-2.5 overflow-hidden">
              <div
                className={`h-full rounded-full transition-all ${
                  isFull ? 'bg-red-500' : isLow ? 'bg-orange-400' : 'bg-blue-400'
                }`}
          ...
          <div className="flex items-center justify-between bg-white/10 rounded-xl px-4 py-2.5 mb-4">
            ...
            <span className="font-black text-xl">₪{tournament.price}
              <span className="text-xs text-blue-300 font-normal mr-1">לשחקן</span>
            </span>
          </div>
          ...
          {!myReg ? (
            <div className="space-y-3">
              {isFull ? (
                <div className="bg-red-900/30 border border-red-500/30 text-red-300 rounded-xl p-3 text-center text-sm font-semibold">
                  הטורניר מלא — כל המקומות תפוסים
                </div>
              ) : (
                <>
                  ...
                  <button
                    ...
                    disabled={registering || !medicalApproved}
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-4">
              ...
              <div className="space-y-2 text-sm text-slate-600">
                ...
                <div className="flex justify-between"><span>מקומות פנויים</span>
                  <span className={`font-semibold ${isFull ? 'text-red-500' : isLow ? 'text-orange-500' : 'text-green-600'}`}>
