    ...
    <div className="bg-[#0f2347] border border-blue-900 rounded-2xl p-6">
      ...
      <div className="relative mb-4">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-[#0f2347] px-2 text-blue-400">או כניסה עם אימייל</span>
        </div>
      </div>
      ...
      <p className="text-center text-blue-400 text-sm mt-4">
        עדיין אין לך חשבון?{' '}
        <Link href="/register" className="text-blue-300 hover:text-white font-semibold">הרשמה</Link>
      </p>
    </div>
  );
}
  ...
  return (
    <div className="min-h-screen bg-[#0a1628] flex items-center justify-center px-4" dir="rtl">
      <div className="w-full max-w-sm">
        ...
        <Suspense fallback={<div className="text-blue-400 text-center">טוען...</div>}>
          <LoginForm />
        </Suspense>
      </div>
    </div>
