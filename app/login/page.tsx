    ...
    <div className="min-h-screen bg-[#0a1628] flex items-center justify-center px-4" dir="rtl">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-blue-300 mt-2">כניסה לחשבון</p>
        </div>
        ...
        <div className="bg-[#0f2347] border border-blue-900 rounded-2xl p-6">
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#0f2347] px-2 text-blue-400">או</span>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full bg-white hover:bg-gray-100 text-gray-800 font-semibold py-3 rounded-xl flex items-center justify-center gap-3 transition-colors"
          >
          ...
          <p className="text-center text-blue-400 text-sm mt-4">
            עדיין אין לך חשבון?{' '}
            <Link href="/register" className="text-blue-300 hover:text-white font-semibold">
              הרשמה
            </Link>
          </p>
        </div>
