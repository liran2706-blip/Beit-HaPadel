...
export async function POST(request: Request) {
  try {
    ...
    const { error } = await resend.emails.send({
      ...
      to: user.email,
      subject: `עדכון הרשמה — ${tournamentTitle}`,
      html: `
        <!DOCTYPE html>
            ...
            <tr>
              <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;max-width:600px;width:100%;">
                  ...
                  <tr>
                    <td style="background:#dc2626;padding:14px;text-align:center;">
                      <p style="margin:0;color:#ffffff;font-size:18px;font-weight:700;">עדכון בנוגע להרשמתך</p>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td style="padding:32px;">
                      ...
                      <p style="margin:0 0 24px;color:#475569;font-size:15px;line-height:1.6;">
                        הרשמתך לטורניר <strong>${tournamentTitle}</strong> בוטלה מאחר ודמי ההשתתפות לא הושלמו במועד.<br/><br/>
                        במידה והנך מעוניין להשתתף בטורניר, ניתן להירשם מחדש דרך האתר ולהשלים את התשלום.
                      </p>
                      ...
                      <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
                        <tr>
                          <td align="center">
                            <a href="https://www.israelpadel.com" style="display:inline-block;background:#2563eb;color:#ffffff;font-size:16px;font-weight:700;padding:14px 32px;border-radius:12px;text-decoration:none;">
                              🎾 להרשמה מחדש
                            </a>
                          </td>
                        </tr>
                      ...
                      <p style="margin:0;color:#475569;font-size:14px;line-height:1.6;">מקווים לראותך בטורניר הבא! 🏓</p>
                    </td>
                  </tr>
