...
export async function POST(request: Request) {
  try {
    ...
    const { error } = await resend.emails.send({
      ...
      to: user.email,
      subject: `התפנה מקום — ${tournamentTitle}`,
      html: `
        <!DOCTYPE html>
            ...
            <tr>
              <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;max-width:600px;width:100%;">
                  ...
                  <tr>
                    <td style="background:#2563eb;padding:14px;text-align:center;">
                      <p style="margin:0;color:#ffffff;font-size:18px;font-weight:700;">🎾 התפנה מקום בטורניר!</p>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td style="padding:32px;">
                      ...
                      <p style="margin:0 0 24px;color:#475569;font-size:15px;line-height:1.6;">
                        בשורות טובות! התפנה מקום בטורניר <strong>${tournamentTitle}</strong>.<br/><br/>
                        על מנת לאשר את השתתפותך, יש להסדיר את תשלום דמי ההשתתפות בהקדם האפשרי. לאחר השלמת התשלום, הרשמתך תאושר סופית.
                      </p>
                      ...
                      <p style="margin:0;color:#ef4444;font-size:13px;font-weight:600;">⚠️ שים לב — המקום אינו שמור וייתכן שיתפס אם התשלום לא יושלם בזמן.</p>
                    </td>
                  </tr>
