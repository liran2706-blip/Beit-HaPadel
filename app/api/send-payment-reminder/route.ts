...
export async function POST(request: Request) {
  try {
    ...
    const { error } = await resend.emails.send({
      ...
      to: user.email,
      subject: `תזכורת תשלום — ${tournamentTitle}`,
      html: `
        <!DOCTYPE html>
              ...
              <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;max-width:600px;width:100%;">
                ...
                <tr>
                  <td style="background:#0a1628;padding:32px;text-align:center;">
                    <h1 style="margin:0;color:#ffffff;font-size:26px;font-weight:900;">בית <span style="color:#60a5fa;">הפאדל</span></h1>
                    <p style="margin:8px 0 0;color:#93c5fd;font-size:14px;">israelpadel.com</p>
                  </td>
                </tr>

                <tr>
                  <td style="background:#f59e0b;padding:14px;text-align:center;">
                    <p style="margin:0;color:#ffffff;font-size:18px;font-weight:700;">💳 תזכורת — השלם את התשלום</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:32px;">
                    ...
                    <p style="margin:0 0 24px;color:#475569;font-size:15px;line-height:1.6;">
                      הרשמתך לטורניר <strong>${tournamentTitle}</strong> התקבלה, אך טרם השלמת את התשלום.<br/>
                      על מנת לאשר את מקומך, יש להשלים את התשלום בהקדם.
                    </p>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;margin-bottom:24px;">
                      <tr><td style="background:#0a1628;padding:12px 16px;">
